...
export default function ResumeJobSearchV3() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('/api/ai-job-search-v4', {
                method: 'POST',
                body: formData,
            })
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <h1 className={`text-5xl md:text-6xl font-bold ${textClass} mb-6 tracking-tight`}>
                            V4: Web Scraping
                            <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"> Job Discovery</span>
                        </h1>

                        <p className={`text-xl ${textSecondaryClass} mb-4 max-w-2xl mx-auto leading-relaxed`}>
                            AI + Real-time web scraping from Indeed, ZipRecruiter & RemoteOK. Most comprehensive results.
                        </p>
